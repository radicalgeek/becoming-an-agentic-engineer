...
const required = [
  ...
  "examples/02-context/rembr-memory-cycle.json",
  "examples/02-context/rembr-memory-fixture.json",
...
for (const script of ["example:classify", "example:context", "example:rag", "example:memory", "example:recursive-context", "example:workflow", "loop:validate", "loop:simulate", "example:ralph", "example:route", "example:team"]) {
